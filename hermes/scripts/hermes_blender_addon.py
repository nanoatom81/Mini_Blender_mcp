...
bl_info = {
    "name": "Hermes Blender",
    "author": "Hermes Agent (fork of ahujasid/blender-mcp)",
    "version": (1, 2),
    "blender": (3, 0, 0),
    "location": "View3D > Sidebar > Hermes Blender",
    "description": "Connect Blender to Hermes Agent via a local socket (no Claude/MCP needed)",
    "category": "Interface",
}
        ...
        if enabled:
            ...
            return {
                ...
                "message": """PolyHaven integration is currently disabled. To enable it:
                            1. In the 3D Viewport, find the Hermes Blender panel in the sidebar (press N if hidden)
                            2. Check the 'Use assets from Poly Haven' checkbox
                            3. Restart the connection to Hermes Agent"""
        }
            ...
            if not hyper3d_api_key:
                return {
                    ...
                    "message": """Hyper3D Rodin integration is currently enabled, but API key is not given. To enable it:
                                ...
                                4. Restart the connection to Hermes Agent"""
                }
...
class BLENDERMCP_AddonPreferences(bpy.types.AddonPreferences):
    ...
    telemetry_consent: BoolProperty(
        ...
        description="Allow collection of prompts, code snippets, and screenshots (off by default for Hermes Agent — no data leaves your machine)",
        default=False
    )
...
class BLENDERMCP_PT_Panel(bpy.types.Panel):
    bl_label = "Hermes Blender"
    bl_idname = "BLENDERMCP_PT_Panel"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'Hermes Blender'
    ...
    def draw(self, context):
        ...
        if not scene.blendermcp_server_running:
            layout.operator("blendermcp.start_server", text="Connect to Hermes Agent")
        else:
            layout.operator("blendermcp.stop_server", text="Disconnect from Hermes Agent")
...
class BLENDERMCP_OT_StartServer(bpy.types.Operator):
    ...
    bl_label = "Connect to Hermes Agent"
    bl_description = "Start the Hermes Blender server to accept commands from Hermes Agent"
...
class BLENDERMCP_OT_StopServer(bpy.types.Operator):
    ...
    bl_label = "Stop the connection to Hermes Agent"
    bl_description = "Stop the connection to Hermes Agent"
